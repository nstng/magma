...
'''
Decorator for lcov coverage generation via Bazel. Various environment variables 
...
def _create_lcov_converter(coverage_file: str) -> coverage_lcov.converter.Converter:
    return coverage_lcov.converter.Converter(
        relative_path=True,
        config_file=False,
